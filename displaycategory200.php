...
<script type="text/javascript">
  ...
  $result2=$conn->query($sql2);
		...
		$sql = "SELECT * FROM product_stock,brand_product,product_type,category WHERE category.id_category= '200' and product_stock.brand_id = brand_product.brand_id and product_stock.type_id=product_type.type_id and product_stock.id_category =category.id_category ORDER BY product_id";
