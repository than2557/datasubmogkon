...
<div class="container" style="width: 100%;background-color: #66b3ff;border-bottom: 3%;border: 5px solid #000000">
  <div class="container" style="width:100%;background-color:#b3d9ff; border-radius: 2%;border-bottom: 3%;">
    ...
    <form class="form-horizontal"  action="insert_em.php"   method="POST" enctype="multipart/form-data" id="form">
 ...
 <?php } ?>  
  ...
  <label class="control-label col-sm-1">ชื่อ:</label>
    <input type="text" name="name" id="name"  class="form-control col-sm-1" style="width: 150px">
 ...
 <?php } ?>  
  ...
  <label class="control-label col-sm-1">อำเภอ:</label>
    ...
    <div class="form-group">
      ...
      <label class="control-label col-md-1" for="zipcode">รหัสไปรษณีย์:</label>
    <input type="text" name="zipcode" id="zipcode" class="form-control col-md-1"  style="width: 200px">
      ...
      <div class="form-group">
        ...
        <input  type="text" class="  form-control control-label col-md-1"  id="username" name="username" style="width: 200px"></label>
      ...
      <input  type="password" class=" form-control control-label col-md-1"  id="password" name="password" style="width: 200px"></label> 
      ...
      <label class="control-label col-sm-2">ที่อยู่:</label>
         <input type="text" class="form-control col-sm-" id="address" name="address"  style="width: 100px;">
    </div>
   </div>
   ...
   <div class="col-sm-12">
     <label class="control-label col-sm-2" >รูป:</label>
      ...
      <label class="control-label col-sm-1">เบอร์ติดต่อ:</label>
        <input type="text"  class="form-control col-sm-1" name="tel" id="tel" style="width:200px;">
